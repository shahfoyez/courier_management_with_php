...
<?php
  class Ship{
    ...
    public function shipingDetails(){
      $query="SELECT  s.*, c.*, b.*
      From tbl_shipperinfo as s, tbl_consigneeinfo as c, tbl_billinginfo as b Where s.reference=c.reference AND c.reference=b.reference
    ...
    public function shipingEdit($data, $archiveEditId){
      ...
      //For History Insert
      $historyInsert="INSERT into tbl_shipingedithistory(reference,editedAt, editedBy) 
        values('$reference','$updatedAt','$adminName')";
