...
<?php
    ...
    if(!isset($_GET['adminUsername']) || $_GET['adminUsername']==NULL){
      ...
      $adminUsername= preg_replace('/[^-a-zA-Z0-9_]/','',$_GET['adminUsername']);
    }
    if($_SERVER['REQUEST_METHOD']=='POST'){
      $adminEdit=$user->adminProfileEdit($_POST, $_FILES, $adminUsername);
    }
?>
<?php
        ...
        <div style="margin-top: 10px;" class="row mt">
          ...
          <?php
            ...
            <div style="border-radius: 3px; box-shadow: 0px 0px 8px 3px #aab2bc;" class="form-panel">
               <!-- Form Start-->
               <form action="" method="post" tyle="padding-left: 5px;" enctype="multipart/form-data" role="form" class="form-horizontal style-form">
              ...
              <!-- User's Contact Info Information Start-->
                ...
                <div style="border-bottom: 0px;" class="form-group">
                  ...
                  <div class="col-lg-6">
                    <input name="num" type="text" placeholder="Phone" class="form-control" value="<?php echo $result['phone']?>">
                  <!--<p class="help-block">Something went wrong</p>-->
                  </div>
                </div>
                ...
                <div class="form-group "><!--has-success-->
                  ...
                  <div class="col-lg-6">
                    <input name="npassword" type="text" placeholder="New Password" class="form-control">
                    <!--<p class="help-block">Successfully done</p>-->
                  </div>
                </div>
                <div style="border-bottom: 0px;" class="form-group">
                  ...
                  <div class="col-lg-5">
                    <input name="cnpassword" type="text" placeholder="Confirm Password" class="form-control">
                  <!--<p class="help-block">Something went wrong</p>-->
                  </div>
                </div>
                <div style="border-bottom: 0px;" class="form-group">
                ...
                <h4 style=" padding:10px; color: #4ecdc4;
                background-color: #2f323a; border-radius: 5px;"><i class="fa fa-pencil"></i> Other Information</h4>
                <div style="border-bottom: 0px;" class="form-group ">
                ...
                <div style="border-bottom: 0px;" class="form-group">
                    ...
                    <div class="col-lg-offset-0 col-lg-10">
                      ...
                      <button onclick="window.location.href='index.php';" name="cancel" class="btn btn-theme04" type="button"><i class="fa fa-close"></i> Back</button>
                    </div>
                </div>
                  ...
                  ?>
                   <tr>
                     ...
                     <td><?php echo $lresult['datee'];?></td>
                      <td><?php echo $fm->textShorten($lresult['browser'], $limit = 44);?></td>
                     <td>
                        <?php 
                          if($lresult['status']==1){ ?> 
                        ...
                        <a onclick="return confirm('Are you sure?')" class="btn btn-danger btn-xs" href="?loginDataDeleteId=<?php echo $lresult['id'];?>&adminUsername=<?php echo $adminUsername;?>"><i class="fa fa-trash-o"></i></a><?php }?>
